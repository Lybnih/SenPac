...
public class telaFase3 extends javax.swing.JFrame implements KeyListener{
    ...
    initComponents();
        ...
        Timer movimentoFantasmasTimer = new Timer(160, new ActionListener() {
    @Override
...
//Teste fantasma perseguir pacman
...
private void moverFantasmas() {
    ...
    for (JLabel fantasma : fantasmas) {
        int direcao = seguirPacman(fantasma, pacman); // Gera um número aleatório entre 0 e 3
...
private void verificarColisaoComFantasmas() {
    ...
    for (JLabel fantasma : fantasmas) {
        if (pacmanBounds.intersects(fantasma.getBounds()) && fantasma.isVisible()) {
            ...
            if (!vida1.isVisible() && !vida2.isVisible() && !vida3.isVisible()) {
...
private boolean todosPontosColetados() {
    for (JLabel ponto : pontos) { // Substitua "pontosFase3" pelos seus pontos na fase 3
        if (ponto.isVisible()) {
            return false; // Ainda há pontos visíveis na fase 3
        }
    }
    return true; // Todos os pontos foram coletados na fase 3
}
...
private void vitoria() {
    ...
    proximaFaseIniciada = true; 
    
    int pontuacaoFinal = pontuacao; // Pontuação da fase 3
    
    telaFase3.pontuacaoTotal += telaFase2.pontuacaoTotal + telaFase1.pontuacaoTotal + pontuacaoFinal;    
    
    String mensagem = "Parabéns! Você venceu a fase 3!\n"
            + "Pontuação Final: " + telaFase3.pontuacaoTotal;;
    JOptionPane.showMessageDialog(null, mensagem);

    
    
    
    Vencer vencer = new Vencer();
    ...
    private void initComponents() {
        ...
        pacman1 = new javax.swing.JLabel();
        fantasma4 = new javax.swing.JLabel();
        fantasma5 = new javax.swing.JLabel();
        ponto157 = new javax.swing.JLabel();
        ponto158 = new javax.swing.JLabel();
        ponto159 = new javax.swing.JLabel();
        ponto160 = new javax.swing.JLabel();
        ponto161 = new javax.swing.JLabel();
        ponto162 = new javax.swing.JLabel();
        ponto163 = new javax.swing.JLabel();
        ponto164 = new javax.swing.JLabel();
        ponto165 = new javax.swing.JLabel();
        fantasma1 = new javax.swing.JLabel();
        pacman = new javax.swing.JLabel();
        fantasma2 = new javax.swing.JLabel();
        fantasma3 = new javax.swing.JLabel();
        ...
        pacman1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        pacman1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/esquerda.png"))); // NOI18N

        fantasma4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fantasma1.png"))); // NOI18N
        fantasma4.setText("jLabel3");

        fantasma5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fantasma1.png"))); // NOI18N
        fantasma5.setText("jLabel3");

        ponto157.setText("jLabel4");

        ponto158.setText("jLabel4");

        ponto159.setText("jLabel4");

        ponto160.setText("jLabel4");

        ponto161.setText("jLabel4");

        ponto162.setText("jLabel4");

        ponto163.setText("jLabel4");

        ponto164.setText("jLabel4");

        ponto165.setText("jLabel4");

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(null);

        fantasma1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fantasma2.png"))); // NOI18N
        fantasma1.setText("jLabel3");
        getContentPane().add(fantasma1);
        fantasma1.setBounds(1070, 180, 30, 30);
        ...
        fantasma2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fantasma3.png"))); // NOI18N
        fantasma2.setText("jLabel3");
        getContentPane().add(fantasma2);
        fantasma2.setBounds(100, 180, 30, 30);

        fantasma3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/fantasma1.png"))); // NOI18N
        fantasma3.setText("jLabel3");
        getContentPane().add(fantasma3);
        fantasma3.setBounds(600, 180, 30, 30);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Fundo/Fase3.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaFase3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel fantasma3;
    private javax.swing.JLabel fantasma4;
    private javax.swing.JLabel fantasma5;
    ...
    private javax.swing.JLabel pacman1;
    ...
    private javax.swing.JLabel ponto157;
    private javax.swing.JLabel ponto158;
    private javax.swing.JLabel ponto159;
    private javax.swing.JLabel ponto16;
    private javax.swing.JLabel ponto160;
    private javax.swing.JLabel ponto161;
    private javax.swing.JLabel ponto162;
    private javax.swing.JLabel ponto163;
    private javax.swing.JLabel ponto164;
    private javax.swing.JLabel ponto165;
