...
public class telaFase1 extends javax.swing.JFrame implements KeyListener{
    ...
    initComponents();
        ...
        Timer movimentoFantasmasTimer = new Timer(250, new ActionListener() {
    @Override
...
private void verificarColisaoComPontos() {
    ...
    if (pontosColetados == totalDePontos && !proximaFaseIniciada){
        iniciarProximaFase();
    }
}
...
private void iniciarProximaFase() {
    ...
    telaFase2.pontuacaoTotal += pontuacaoFinal;// Adiciona a pontuação da fase atual à pontuação total
    
    

    telaFase2 fase2 = new telaFase2();
    ...
    private void initComponents() {
        ...
        fantasma1.setBounds(590, 240, 30, 30);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Fundo/Fase1.png"))); // NOI18N
